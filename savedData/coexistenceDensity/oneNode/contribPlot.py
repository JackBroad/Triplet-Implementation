...
mp.savefig(dirString+'/'+'fullBoxContribPlot-Np_40_Zoom_NormDensOneNode.pdf',bbox_inches = "tight")
...
mp.ylabel(r"t$_{N_{p}}$ / s")
mp.legend(loc="upper right")
mp.savefig(dirString+'/'+'atomMoveContribPlot-Np_40_Zoom_NormDensOneNode.pdf',bbox_inches = "tight")
