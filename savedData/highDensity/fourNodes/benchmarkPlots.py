...
ax1.plot(nProcs,a*nProcs+b,c='r',label=r"0.46x+0.66")
mp.grid()
mp.xlabel(r"$N_{p}}$")
...
ax2.plot(nProcs,a*nProcs+b,c='r',label=r"0.66x+0.40")
mp.grid()
mp.xlabel(r"$N_{p}}$")
mp.ylabel(r"t$_1$ / t$_{N_{p}}$")
mp.legend(loc="upper left")
mp.savefig(dirString+'/'+'atomMoveSpeedUpConds_Np-120.pdf',bbox_inches = "tight")
...
ax3.plot(nProcs,a*nProcs+b,c='r',label=r"0.91x+0.31")
mp.grid()
mp.xlabel(r"$N_\mathrm{p}}$")
mp.ylabel(r"t$_1$ / t$_{N_{\mathrm{p}}}$")
mp.legend(loc="upper left")
mp.savefig(dirString+'/'+'tripSumMoveSpeedUp_Np-120.pdf',bbox_inches = "tight")

a,b = np.polyfit(nProcs[0:6],fullBoxTriplets[0:6],1)
print(a,b)
figggg=mp.figure()
ax4=figggg.add_subplot(111)
ax4.scatter(nProcs,fullBoxTriplets,s=75,c="g",marker="o",label=r"t$_1$ = "+str(fTripT0)+" s")
ax4.plot(nProcs,a*nProcs+b,c='r',label=r"0.78x+0.69")
mp.grid()
mp.xlabel(r"$N_\mathrm{p}}$")
mp.ylabel(r"t$_1$ / t$_{N_{\mathrm{p}}}$")
mp.legend(loc="upper left")
mp.savefig(dirString+'/'+'tripFullBoxSpeedUp_Np-120.pdf',bbox_inches = "tight")
