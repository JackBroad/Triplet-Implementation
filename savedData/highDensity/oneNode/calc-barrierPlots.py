...
ax1.scatter(nProcs,fullBoxTriplets,s=75,c="g",marker="o",label=r"t$_1$ = "+str(fTripT0)+" s")
mp.grid()
mp.xlabel(r"$N_\mathrm{p}}$")
mp.ylabel(r"t$_1$ / t$_{N_\mathrm{p}}$")
mp.legend(loc="upper left")
mp.savefig(dirString+'/'+'calc-barrier_fullSpeedUp.pdf',bbox_inches = "tight")

figg=mp.figure()
ax2=figg.add_subplot(111)
ax2.scatter(nProcs,atomMoveTriplets,s=75,c="g",marker="o",label=r"t$_1$ = "+str(tripT0)+" s")
mp.grid()
mp.xlabel(r"$N_\mathrm{p}}$")
mp.ylabel(r"t$_1$ / t$_{N_\mathrm{p}}$")
mp.legend(loc="upper left")
mp.savefig(dirString+'/'+'calc-barrier_moveSpeedUp.pdf',bbox_inches = "tight")
