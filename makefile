...
FC = mpif90
FCFLAGS =  -c -cpp  -Wall -Wextra -Wno-do-subscript -fallow-argument-mismatch -DASSERTS #-Wconversion -Wno-unused-parameter -ffpe-trap=invalid -ffpe-trap=zero,overflow,underflow -fbacktrace -fdump-core -fcheck=bounds -Wno-tabs  #-fmax-errors=5
